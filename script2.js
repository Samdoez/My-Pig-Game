...
initializevalues();
    ...
    document.querySelector(".btn-roll").addEventListener("click", function(){
        if (gamePlaying){ // this is checking if the rolling of dice should continue, if false dont work, if true u can roll d dice
            ...
            dice = Math.floor( (Math.random() * 6) + 1 ) ; // generating a random value
...
document.querySelector(".btn-hold").addEventListener("click", function(){
    if (gamePlaying){
        ...
        // check for a winner, using our tenary operator
...
function toggleplayer(){
            document.querySelector(".dice" ).textContent = "oops you rolled a 1";
            ...
            document.querySelector(".dice").style.display = "none"; // to hide d dice again
